...
new class extends Component {
	...
	// Image URL with a version stamp, so browsers re-download an image whenever the file changes
	public function image(string $name): string
	{
		$path = "{$this->folder}/{$name}.png";
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 1rem; width: 100%; max-width: {{ $size }}; margin-inline: auto;">
	...
	>
		<img src="{{ $this->image('dial') }}" alt="Watch dial" style="position: absolute; inset: 0; width: 100%; height: 100%;">
